...
function flatsome_posted_on() {
	printf( __( 'Postado em <a href="%1$s" title="%2$s" rel="bookmark"><time class="entry-date" datetime="%3$s">%4$s</time></a><span class="meta-author"> por: <strong><a class="url fn n" href="%5$s" title="%6$s" rel="author">%7$s</a></strong></span>.', 'flatsome' ),
                                        ...
                                        if ($_product->exists() && $cart_item['quantity']>0) :  ?>  
                                      	...
                                      	<div class="row mini-cart-item collapse">
                                      		...
                                      		<div class="small-7 columns"><?php 
                                                 ...
                                                 echo '<div class="cart_list_product_quantity"> '.__('Quantity:', 'flatsome').' '.$cart_item['quantity'].'</div>';
