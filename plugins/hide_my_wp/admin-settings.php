        ...
        $fields['general'] = 
                array(
                        ...
                        array(
                            ...
                            'desc' => __( 'If you use a customized htaccess and don\'t want to allow HMWP update it automatically choose this option. Instead you need to <a href="?page='.self::slug.'&single_config=1">configure it manually</a>.', self::slug ),
                            'type' => 'checkbox',
                            'default' => '',
                            'class' =>''
                            )
                        ...
                        array(
                         ...
                         array(
                            ...
                            'desc' => __( 'Remove whitespaces and comments from HTML (Use with cache).', self::slug ),
                            'type' => 'select',
                            'default' => '',
                            'class' =>'',
                            'options' => array(
                        ...
                        ,
                         ...
                         array(
                            ...
                            'desc' => __( 'Replace keywords in HTML output. case-sensitive. One per line. e.g. old=new <br/> Use [equal] when \'=\' is in keywords ', self::slug ),
                            'type' => 'textarea',
                            'default' => '',
                            'class' =>''
                            ) 
